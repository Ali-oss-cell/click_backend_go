...
echo "🔧 Fixing admin password hash using Docker..."
...
# Run the fix script using Docker (same environment as the backend)
docker-compose exec backend go run fix_admin_temp.go
